...
{
    /// <summary>
    /// Provides extension methods for <see cref="UniTask"/>.
    /// </summary>
    [PublicAPI]
    public static class UniTaskExtensions
    {
        ...
        public static UniTask<Result<TResult>> SuppressAsync<TResult>(
            this UniTask<TResult> task,
            [CallerMemberName] string methodName = "",
            [CallerFilePath] string filePath = "")
            => ExecuteSuppressedAsync(task, methodName, filePath);
        ...
        public static UniTask<Result<TResult>> SuppressAsync<TResult>(
            ...
            [CallerMemberName] string methodName = "",
            [CallerFilePath] string filePath = "")
            => ExecuteSuppressedAsync(task.AttachExternalCancellation(cancellationToken), methodName, filePath);
